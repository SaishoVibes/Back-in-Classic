...
public class ClassicOverworldDimension extends BackInClassicModElements.ModElement {
	public ClassicOverworldDimension(BackInClassicModElements instance) {
		super(instance, 90);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("back_in_classic:classic_overworld"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
