...
public class HighCliffsBiome extends BackInClassicModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-4599553).setWaterColor(-16763956).setWaterFogColor(-16763956)
						.withSkyColor(-4599553).withFoliageColor(-16744641).withGrassColor(-16744641).build();
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.ZOMBIE, 5, 4, 4));
